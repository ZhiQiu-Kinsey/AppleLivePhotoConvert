...
- **文档**：README（中英）、AGENTS.md（最后更新版本与日期、技术栈、目录结构、各规范）、CHANGELOG `## [4.0.0]`；用 Avalonia Headless 截图更新 `docs/screenshots/`（浅色/深色、中/英）；删除 `docs/preview.png`（已移除 CLI 的截图）或更新引用。
